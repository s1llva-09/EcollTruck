...
public class AuthRepository {
    ...
    // ATENÇÃO: Use a chave pública (anon key) do Supabase, não a chave secreta (secret key).
    // A chave secreta nunca deve ser exposta no lado do cliente (app).
    // Vá em Project Settings > API no seu painel do Supabase e copie a chave "anon" "public".
