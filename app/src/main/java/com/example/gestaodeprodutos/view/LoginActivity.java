        ...
        viewModel.getLoginResult().observe(this, authResponse -> {
            if (authResponse != null && authResponse.getUser() != null) {
                ...
                getSharedPreferences("APP", MODE_PRIVATE)
                        .edit()
                        .putString("TOKEN", authResponse.getTokenType() + " " + authResponse.getAccessToken())
                        .apply();

                // Lógica de redirecionamento
                // Acessa o email através do getter
                boolean isAdmin = ADMIN_EMAIL.equalsIgnoreCase(authResponse.getUser().getEmail());
